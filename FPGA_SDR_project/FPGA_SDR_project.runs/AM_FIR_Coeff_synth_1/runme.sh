...
HD_PWD='C:/Users/Charles/Desktop/MIT/Fall 2019/6_111/FPGA SDR Final Project/FPGA_SDR/FPGA_SDR/FPGA_SDR_project/FPGA_SDR_project.runs/AM_FIR_Coeff_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AM_FIR_Coeff.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AM_FIR_Coeff.tcl
