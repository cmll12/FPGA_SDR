...
HD_PWD='/afs/athena.mit.edu/user/c/m/cmll/six_111/project/FPGA_SDR/FPGA_SDR_project/FPGA_SDR_project.runs/adc_ila_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adc_ila.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adc_ila.tcl
