...
HD_PWD='C:/Users/Charles/Desktop/MIT/Fall 2019/6_111/FPGA SDR Final Project/FPGA_SDR/FPGA_SDR/FPGA_SDR_project/FPGA_SDR_project.runs/am_bp_ila_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log am_bp_ila.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source am_bp_ila.tcl
