...
HD_PWD='/afs/athena.mit.edu/user/c/o/colinpc/6.111 Final Project/FPGA_SDR/FPGA_SDR_project/FPGA_SDR_project.runs/fft_mag_xfft_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fft_mag_xfft_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fft_mag_xfft_0_0.tcl
