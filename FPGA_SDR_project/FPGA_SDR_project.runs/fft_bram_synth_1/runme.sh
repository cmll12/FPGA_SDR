...
HD_PWD='/afs/athena.mit.edu/user/c/o/colinpc/6.111 Final Project/FPGA_SDR/FPGA_SDR_project/FPGA_SDR_project.runs/fft_bram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fft_bram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fft_bram.tcl
