...
HD_PWD='/afs/athena.mit.edu/user/c/m/cmll/six_111/project/FPGA_SDR/FPGA_SDR_project/FPGA_SDR_project.runs/am_detect_ila_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log am_detect_ila.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source am_detect_ila.tcl
