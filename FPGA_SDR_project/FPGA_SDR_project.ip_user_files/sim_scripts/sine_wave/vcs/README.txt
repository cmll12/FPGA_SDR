...
#
# Generated by export_simulation on Thu Nov 21 14:51:38 -0500 2019
#
################################################################################
...
'-reset_run' switch to the './sine_wave.sh' script.

./sine_wave.sh -reset_run
...
./sine_wave.sh -noclean_files

For more information on the script, please type './sine_wave.sh -help'.
