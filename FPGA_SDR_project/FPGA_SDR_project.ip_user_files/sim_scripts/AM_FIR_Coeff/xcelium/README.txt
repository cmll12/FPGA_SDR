...
#
# Generated by export_simulation on Fri Nov 22 16:29:06 -0500 2019
#
################################################################################
...
'-reset_run' switch to the './AM_FIR_Coeff.sh' script.

./AM_FIR_Coeff.sh -reset_run
...
./AM_FIR_Coeff.sh -noclean_files

For more information on the script, please type './AM_FIR_Coeff.sh -help'.
