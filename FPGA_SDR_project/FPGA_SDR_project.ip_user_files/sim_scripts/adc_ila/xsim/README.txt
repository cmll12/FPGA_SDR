...
#
# Generated by export_simulation on Sun Nov 10 23:49:59 -0500 2019
#
################################################################################
...
'-reset_run' switch to the './adc_ila.sh' script.

./adc_ila.sh -reset_run
...
./adc_ila.sh -noclean_files

For more information on the script, please type './adc_ila.sh -help'.
