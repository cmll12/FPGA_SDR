...
#
# Generated by export_simulation on Tue Nov 26 17:42:05 -0500 2019
#
################################################################################
...
'-reset_run' switch to the './am_bp_ila.sh' script.

./am_bp_ila.sh -reset_run
...
./am_bp_ila.sh -noclean_files

For more information on the script, please type './am_bp_ila.sh -help'.
